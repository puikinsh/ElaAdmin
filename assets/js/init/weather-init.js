  ...
  function loadWeather(location, woeid) {
    $.simpleWeather({
      ...
      success: function (weather) {
        ...
        html +=
          '<div class="city">' + weather.city + '  <span> ' + weather.region + '</span></div>';
        ...
        html +=
          '<div class="days day2"><span class="d">' +
          weather.forecast[1].day +
          '</span> <span class="h">' +
          weather.forecast[1].alt.high +
          '&deg; </span> <span class="h">' +
          weather.forecast[1].alt.low +
          '&deg;  </div>';
        html +=
          '<div class="days day3"><span class="d">' +
          weather.forecast[2].day +
          '</span> <span class="h">' +
          weather.forecast[2].alt.high +
          '&deg; </span> <span class="h">' +
          weather.forecast[2].alt.low +
          '&deg;  </div>';
        html +=
          '<div class="days day4"><span class="d">' +
          weather.forecast[3].day +
          '</span> <span class="h">' +
          weather.forecast[3].alt.high +
          '&deg; </span> <span class="h">' +
          weather.forecast[3].alt.low +
          '&deg;  </div>';
        html +=
          '<div class="days day5"><span class="d">' +
          weather.forecast[4].day +
          '</span> <span class="h">' +
          weather.forecast[4].alt.high +
          '&deg; </span> <span class="h">' +
          weather.forecast[4].alt.low +
          '&deg;  </div>';
        html +=
          '<div class="days day1"><span class="d">' +
          weather.forecast[5].day +
          '</span> <span class="h">' +
          weather.forecast[5].alt.high +
          '&deg; </span> <span class="h">' +
          weather.forecast[5].alt.low +
          '&deg;  </div>';
        html += '</div>';
