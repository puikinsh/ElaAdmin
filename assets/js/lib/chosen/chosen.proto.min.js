    ...
    (e = (function () {
      ...
      return (
        ...
        (e.prototype.winnow_results = function () {
          var e, t, s, i, r, n, o, l, h, c, a, _, u, d, p;
          for (
            this.no_results_clear(),
              c = 0,
              e = (o = this.get_search_text()).replace(/[-[\]{}()*+?.,\\^$|#\s]/g, '\\$&'),
              h = this.get_search_regex(e),
              s = 0,
              i = (l = this.results_data).length;
            s < i;
            s++
          )
            (((r = l[s]).search_match = !1),
              (a = null),
              (_ = null),
              (r.highlighted_html = ''),
              this.include_option_in_results(r) &&
                ...
                (r.group && !this.group_search) ||
                  ((_ = this.search_string_match(p, h)),
                  (r.search_match = null != _),
                  r.search_match && !r.group && (c += 1),
                  r.search_match
                    ? (o.length &&
                        ((u = _.index),
                        (n = p.slice(0, u)),
                        (t = p.slice(u, u + o.length)),
    ...
    (this.Chosen = (function (s) {
      ...
      return (
        ...
        (r.prototype.no_results_clear = function () {
          var e, t;
          for (e = null, t = []; (e = this.search_results.down('.no-results')); )
            t.push(e.remove());
          return t;
        }),
