...
(function (_) {
  ...
  _.sc = function () {
    return (
      _.Pb('Safari') &&
      !(rc() || _.Pb('Coast') || _.Pb('Opera') || _.Pb('Edge') || _.Pb('Silk') || _.Pb('Android'))
    );
  };
  rc = function () {
  ...
  _.Xd = function (a, b) {
    ...
    if (a) {
      ...
      360 <= b - a
        ...
        : ((a = _.Za(a, -180, 180)), (b = _.Za(b, -180, 180)), (this.b = new Qc(a, b)));
  ...
  ye = function (a) {
    ...
    _.va(a) || a instanceof _.be
      ? 0 == _.w(a)
        ? (b = !0)
        : ((b = a instanceof _.be ? a.getAt(0) : a[0]), (b = _.va(b) || b instanceof _.be))
      : (b = !1);
  ...
  Je = function (a) {
    ...
    var b;
    _.ya(a)
      ? ((b = window.document.createElement('div')), (b.style.overflow = 'auto'), (b.innerHTML = a))
  ...
  Dg = function () {
    ...
    6 == this.type &&
      ...
      ((this.type = 1), (this.version = new Ag((0, window.parseInt)(b[1], 10))));
    for (b = 1; 7 > b; ++b)
  ...
  Kg = function () {
    ...
    a: {
      for (
        ...
        try {
          if (
            ((d.style.background = f + '(left, #000, #fff)'), -1 != d.style.background.indexOf(f))
          ) {
            b = f;
            break a;
          }
  ...
  Ng = function (a, b) {
    null != a.style.opacity
      ? (a.style.opacity = b)
      : (a.style.filter = b && 'alpha(opacity=' + Math.round(100 * b) + ')');
  };
  Og = function (a) {
    a = a.get('opacity');
  ...
  _.Wh =
    Xh && _.Hh
      ? Nc() || ('CSS1Compat' == Xh.compatMode ? (0, window.parseInt)(_.Oc, 10) : 5)
      : void 0;
  _.k = Qc.prototype;
  ...
  _.k.Ei = function (a) {
    ...
    var b = this.f,
      c = a.f;
    return (
      (b.isEmpty() ? c.isEmpty() : 1e-9 >= Math.abs(c.f - b.f) + Math.abs(b.b - c.b)) &&
      _.Tc(this.b, a.b)
    );
  };
