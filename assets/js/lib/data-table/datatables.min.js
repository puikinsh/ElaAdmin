...
(function (Fa, T, k) {
  var S = function (g) {
        ...
        jb = function (a) {
          if (c === k || c === j)
            ((i = l[j]),
              ...
              i && i._bAttrSrc
                ? (Q(i.mData._)(d, n), q(i.mData.sort, a), q(i.mData.type, a), q(i.mData.filter, a))
                : r
      ...
      for (c = l.length; b < c; b++)
        ((f = l[b]),
          ...
          a.oFeatures.bSort &&
            ...
            !1 !== f.bSortable &&
              (d.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), Pa(a, f.nTh, b))),
        ...
        for (e = h.length; d < e; d++) {
          ...
          for (b = h[d].length; f < b; f++)
            if (((n = j = 1), i[d][f] === k)) {
              ...
              for (i[d][f] = 1; h[d + j] !== k && h[d][f].cell == h[d + j][f].cell; )
                ((i[d + j][f] = 1), j++);
        ...
        if (0 !== j.length) {
          ...
          for (i = i ? 0 : h; i < f; i++) {
            ...
            if (0 !== e) {
              var q = d[c % e];
              r._sRowStripe != q &&
                (g(l).removeClass(r._sRowStripe).addClass(q), (r._sRowStripe = q));
            }
    ...
    function xb(a, b, c, d, e, f) {
      if ('' !== b)
        for (var h = a.aiDisplay, d = Ra(b, d, e, f), e = h.length - 1; 0 <= e; e--)
    ...
    function ob(a) {
      for (
        var b = a.oClasses,
          ...
          f = e ? d[0] : d,
          d = e ? d[1] : d,
          e = g('<select/>', { name: c + '_length', 'aria-controls': c, class: b.sLengthSelect }),
          h = 0,
          i = f.length;
        h < i;
        h++
    ...
    function Ha(a) {
      ...
      if (d || (!q && !f && !e && i == ba(a) && i == n.length))
        ...
        if (a.aoData.length)
          for (m = 0; m < j.length; m++)
            ((q = j[m]), (o = c[q]), g(Gb(a, q)).clone(!1).append(o.sContentPadding).appendTo(t));
        q = g('<div/>')
          .css(
            f || e
    ...
    function Kb(a) {
      for (
        var b, c, d = a.aoColumns, e = V(a), a = a.oLanguage.oAria, f = 0, h = d.length;
        f < h;
        f++
      ) {
        c = d[f];
    ...
    function xa(a) {
      ...
      if (e.bSort && e.bSortClasses) {
        e = 0;
        for (f = b.length; e < f; e++)
          ((h = b[e].src), g(D(a.aoData, 'anCells', h)).removeClass(c + (2 > e ? e + 1 : 3)));
        e = 0;
        for (f = d.length; e < f; e++)
          ((h = d[e].src), g(D(a.aoData, 'anCells', h)).addClass(c + (2 > e ? e + 1 : 3)));
      }
      a.aLastSort = d;
    }
    function Jb(a, b) {
    ...
    function J(a, b, c, d) {
      ...
      d &&
        (c += '. For more information about this error, please see http://datatables.net/tn/' + d);
        ...
        if ('table' != this.nodeName.toLowerCase())
          ...
          f.bJQueryUI
            ? (g.extend(j, m.ext.oJUIClasses, f.oClasses),
              f.sDom === l.sDom && 'lfrtip' === l.sDom && (o.sDom = '<"H"lfr>t<"F"ip>'),
              o.renderer)
          ...
          o.iInitDisplayStart === k &&
            ((o.iInitDisplayStart = f.iDisplayStart), (o._iDisplayStart = f.iDisplayStart));
          ...
          o.nTBody = i[0];
          i = r.children('tfoot');
          if (0 === i.length && 0 < e.length && ('' !== o.oScroll.sX || '' !== o.oScroll.sY))
        ...
        if (a !== k && f.bVisible !== a) {
          if (a) {
            ...
            for (j = h.length; i < j; i++)
              ((n = h[i].nTr), (e = h[i].anCells), n && n.insertBefore(e[d], e[l] || null));
          ...
          g(a.nTable).on('order.dt.DT', function (e, f, g, i) {
            if (a === f) {
              ...
              b.removeClass(c.sSortingClass + ' ' + d.sSortAsc + ' ' + d.sSortDesc).addClass(
                i[e] == 'asc' ? d.sSortAsc : i[e] == 'desc' ? d.sSortDesc : c.sSortingClass
              );
            }
          });
        },
